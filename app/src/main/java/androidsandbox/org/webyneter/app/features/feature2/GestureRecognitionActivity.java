...
public class GestureRecognitionActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feature2_gesture_recognition);
        ...
        GestureOverlayView gov = (GestureOverlayView) findViewById(R.id.feature2_cvCreateOverlay);
    ...
    private void initializeUiVariables() {
        tvRecognitionResult = (TextView) findViewById(R.id.feature2_tvRecognitionResult);
    }
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (predictions.size() > 0) {
            ...
            if (prediction.score > PREDICTION_SCORE_THRESHOLD) {
                ...
                tvRecognitionResult.setText(R.string.feature2_no_match_found);
            }
        }
    }
