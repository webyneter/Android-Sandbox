package androidsandbox.org.webyneter.app.capabilities.capability7;
...
public class SpeechToTextActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cap7);

        initUiVariables();

        lvRecognizedSpeechAdapter = new ArrayAdapter<>(this, R.layout.fragment_cap7_recognition_result,
                R.id.cap7_tvRecognitionResult);
    ...
    private void initUiVariables() {
        btnRequestRecordAudioPermission = (Button) findViewById(R.id.cap7_btnRequestRecordAudioPermission);
        tbtnRecognition = (ToggleButton) findViewById(R.id.cap7_tbtnRecognition);
        pbRecognition = (ProgressBar) findViewById(R.id.cap7_pbRecognition);
        tvErrorMsg = (TextView) findViewById(R.id.cap7_tvErrorMsg);
        lvRecognizedSpeech = (ListView) findViewById(R.id.cap7_lvRecognizedSpeech);
    }
