package androidsandbox.org.webyneter.app.capabilities.capability1;
...
public class HandlingGesturesActivity extends AppCompatActivity implements GestureDetector.OnGestureListener,
    ...
    private void initUiVariables() {
        tvGesture = (TextView) findViewById(R.id.cap1_tvGesture);

        rlXandY = (RelativeLayout) findViewById(R.id.cap1_rlXandY);
        tvX = (TextView) findViewById(R.id.cap1_tvX);
        tvY = (TextView) findViewById(R.id.cap1_tvY);

        rlFlingVelocities = (RelativeLayout) findViewById(R.id.cap1_rlFlingVelocities);
        tvFlingVelocityX = (TextView) findViewById(R.id.cap1_tvFlingVelocityX);
        tvFlingVelocityY = (TextView) findViewById(R.id.cap1_tvFlingVelocityY);

        rlScrollDistances = (RelativeLayout) findViewById(R.id.cap1_rlScrollDistances);
        tvScrollDistanceX = (TextView) findViewById(R.id.cap1_tvScrollDistanceX);
        tvScrollDistanceY = (TextView) findViewById(R.id.cap1_tvScrollDistanceY);
    }
