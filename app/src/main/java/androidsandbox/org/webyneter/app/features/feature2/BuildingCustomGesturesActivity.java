...
public class BuildingCustomGesturesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feature2_create_gesture);

        initUiVariables();
    }

    private void initUiVariables() {
        btnCreateDone = findViewById(R.id.feature2_btnCreateDone);
        ((GestureOverlayView) findViewById(R.id.feature2_cvCreateOverlay))
    ...
    public void addGesture(View v) {
        if (gesture != null) {
            final TextView input = (TextView) findViewById(R.id.feature2_etCreateName);
