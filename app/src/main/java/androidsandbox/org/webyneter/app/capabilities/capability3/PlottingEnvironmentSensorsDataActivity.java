package androidsandbox.org.webyneter.app.capabilities.capability3;
...
public class PlottingEnvironmentSensorsDataActivity extends Activity
    ...
    private void initUiVariables() {
        tvVisibleXRangeMaximum = (TextView) findViewById(R.id.cap3_tvVisibleXRangeMaximum);
        sbVisibleXRangeMaximum = (SeekBar) findViewById(R.id.cap3_sbVisibleXRangeMaximum);
        lcPressure = (LineChart) findViewById(R.id.cap3_lcPressure);
        lcAmbientTemperature = (LineChart) findViewById(R.id.cap3_lcAmbientTemperature);
        lcLight = (LineChart) findViewById(R.id.cap3_lcLight);
        lcRelativeHumidity = (LineChart) findViewById(R.id.cap3_lcRelativeHumidity);
    }
