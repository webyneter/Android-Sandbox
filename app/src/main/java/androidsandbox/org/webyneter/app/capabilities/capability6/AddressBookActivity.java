 ...
 */
public class AddressBookActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cap6);
        ...
        if (Intent.ACTION_SEARCH.equals(getIntent().getAction())) {
            ...
            ContactsListFragment mContactsListFragment = (ContactsListFragment)
                    getSupportFragmentManager().findFragmentById(R.id.cap6_contact_list);
        ...
        if (isTwoPaneLayout) {
            ...
            contactDetailFragment = (ContactDetailFragment)
                    getSupportFragmentManager().findFragmentById(R.id.cap6_contact_detail);
        }
    }
