...
package androidsandbox.org.webyneter.app.capabilities.capability5;
...
//        ImageGalleryFragment.setImageThumbnailLoader(this);
    ...
    private void startImageGalleryActivity() {
        ...
        bundle.putString(ImageGalleryActivity.KEY_TITLE, getResources().getString(R.string.cap5_name));
