...
public class GestureRecognitionActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task2_gesture_recognition);
    ...
    private void initializeUiVariables() {
        tvRecognitionResult = (TextView) findViewById(R.id.task2_tvRecognitionResult);
    }
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (predictions.size() > 0) {
            ...
            if (prediction.score > PREDICTION_SCORE_THRESHOLD) {
                ...
                tvRecognitionResult.setText(R.string.task2_no_match_found);
            }
        }
    }
